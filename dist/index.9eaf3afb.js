...
})({"j5ehK":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d3ac659b9eaf3afb";
"use strict";
...
},{}],"9267r":[function(require,module,exports) {
var _index = require("../src/index");
const fobal = new (0, _index.Client)(api_key = "apiiKey");
console.log(fobal.baseURL);
fobal.baseURL = "http://localhost:5000/data";
async function main() {
    var league = await fobal.getLeague({
        name: "serie-a"
    });
    let milan = await fobal.getTeam({
        name: "milan"
    });
    console.log(milan);
    let rafaLeato = await fobal.getPlayers({
        name: "sergej"
    });
    console.log(rafaLeato);
    fixt = await fobal.getFixture({
        home: "milan",
        away: "juventus"
    });
    console.log(fixt);
...
parcelHelpers.export(exports, "League", ()=>(0, _models.League));
parcelHelpers.export(exports, "Team", ()=>(0, _models.Team));
parcelHelpers.export(exports, "Player", ()=>(0, _models.Player));
parcelHelpers.export(exports, "Fixture", ()=>(0, _models.Fixture));
var _client = require("./fobal/Client");
var _models = require("./models");

},{"./fobal/Client":"4xmGz","./models":"i6QPt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4xmGz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/////////////////////////////
...
var _models = require("../models");
class Client {
    constructor(api_key, api_version = "v1"){
    ...
    processData(data, entityClass) {
        return data.map((item)=>new entityClass(this, item));
    }
    // API Endpoints
    async getLeagues(params = {}) {
        const data = await this.request("GET", "/leagues/", params);
        return this.processData(data, (0, _models.League));
    }
    async getLeague(params = {}) {
        const data = await this.request("GET", "/leagues/", params);
        const result = this.processData(data, (0, _models.League));
        return result.length > 0 ? result[0] : null;
    }
    async getFixtures(params = {}) {
        const data = await this.request("GET", "/fixtures/", params);
        return this.processData(data, (0, _models.Fixture));
    }
    async getFixture(params = {}) {
        const data = await this.request("GET", "/fixtures/", params);
        const result = this.processData(data, (0, _models.Fixture));
        return result.length > 0 ? result[0] : null;
    }
    //##############################
    async getTeams(params = {}) {
        const data = await this.request("GET", "/teams/", params);
        return this.processData(data, (0, _models.Team));
    }
    async getTeam(params = {}) {
        const data = await this.request("GET", "/teams/", params);
        const result = this.processData(data, (0, _models.Team));
        return result.length > 0 ? result[0] : null;
    }
    async getPlayers(params = {}) {
        const data = await this.request("GET", "/players/", params);
        return this.processData(data, (0, _models.Player));
    }
    async getPlayer(params = {}) {
        const data = await this.request("GET", "/players/", params);
        const result = this.processData(data, (0, _models.Player));
        return result.length > 0 ? result[0] : null;
    }
}

},{"axios":"jo6P5","../models":"i6QPt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var Buffer = require("75b56f62563c526e").Buffer;
"use strict";
/**
...
},{"75b56f62563c526e":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("12a1f9571d603e64");
var ieee754 = require("8b1b5104779ba300");
...
},{"12a1f9571d603e64":"eIiSV","8b1b5104779ba300":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6QPt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "League", ()=>(0, _league.League));
parcelHelpers.export(exports, "Team", ()=>(0, _team.Team));
parcelHelpers.export(exports, "Player", ()=>(0, _player.Player));
parcelHelpers.export(exports, "Fixture", ()=>(0, _fixture.Fixture));
var _league = require("./League");
var _team = require("./Team");
var _player = require("./Player");
var _fixture = require("./Fixture");

},{"./League":"eh5AI","./Team":"7JNTs","./Player":"gIgzt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Fixture":"hzFsm"}],"eh5AI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "League", ()=>League);
var _ = require(".");
class League {
    ...
    async getTeams() {
        ...
        return this.client.processData(data, (0, _.Team));
    }
    async getPlayers() {
        const data = await this.client.request("GET", `/leagues/${this.league_id}/players`);
        return this.client.processData(data, (0, _.Player));
    }
}

},{".":"i6QPt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7JNTs":[function(require,module,exports) {
...
class Team {
    ...
    async getPlayers() {
        ...
        return this.client.processData(data, (0, _player.Player));
    }
    async getLeague() {
        const data = await this.client.request("GET", `/teams/${this.team_id}/league`);
        return this.client.processData(data, (0, _league.League))[0];
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Player":"gIgzt","./League":"eh5AI"}],"gIgzt":[function(require,module,exports) {
...
class Player {
    ...
    async getTeam() {
        ...
        return this.client.processData(data, (0, _team.Team))[0];
    }
    async getLeague() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Team":"7JNTs","./League":"eh5AI"}],"hzFsm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Fixture", ()=>Fixture);
var _team = require("./Team");
var _player = require("./Player");
class Fixture {
    constructor(client, data){
    ...
    async getTeams() {
        ...
        return this.client.processData(data, (0, _team.Team));
    }
    async getPlayers() {
        const data = await this.client.request("GET", `/fixtures/${this.fixture_id}/players`);
        return [
            this.client.processData(data[0], (0, _player.Player)),
            this.client.processData(data[1], (0, _player.Player))
        ];
    }
}

},{"./Team":"7JNTs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Player":"gIgzt"}]},["j5ehK","9267r"], "9267r", "parcelRequirefd26")

//# sourceMappingURL=index.9eaf3afb.js.map
